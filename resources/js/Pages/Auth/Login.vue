        ...
        <form @submit.prevent="submit">
            ...
            <div class="block mt-4">
                <label class="flex items-center">
                    ...
                    <span class="ms-2 text-sm ">Lembrar minha senha</span>
                </label>
            </div>
            ...
            <div class="flex items-center justify-end mt-4">
                ...
                <PrimaryButton class="ms-4 text-text hover:bg-dark" :class="{ 'opacity-25': form.processing }" :disabled="form.processing">
                    Entrar
                </PrimaryButton>
            </div>
        </form>
